...
public class Atm_Interface {
    ...
    void withdraw_Amount() {
        ...
        if (balance-5000 >= Amount) {
            ...
            System.out.println("Insuffucient Balance Or Cannot Withdraw Above Minimum Balance Limit");
        }
    ...
    public static void transfer_Money() {
        ...
        String Account_number_1 = sc.nextLine();

        try{
        if (Account_number_1.equals(Account_number)) 
         /*it checks whether the account number is same as of sender
          if yes then it shows the following Message... */
        
        {
            System.out.println(" Cannot Transfer to the Same Account number of The Sender");
        }
        else {
            ...
            if (balance >= Amount) {
                if (Amount <= 50000f) {
                    ...
                    String str = Amount + " Ruppes Transferred To " + act_holder + "A/c no. " + Account_number_1
                            + ". \n";
                    Transaction_history = Transaction_history.concat(str);
    ...
    // Transaction historu=y operation...
